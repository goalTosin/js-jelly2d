...
class GUI {
  ...
  add(t, e, s, n, r) {
    if (Object(s) === s) return new OptionController(this, t, e, s);
    const l = t[e];
    switch (typeof l) {
      case 'number':
        return new NumberController(this, t, e, s, n, r);
      case 'boolean':
        return new i(this, t, e);
      case 'string':
        return new StringController(this, t, e);
      case 'function':
        return new FunctionController(this, t, e);
    }
    console.error(
      'gui.add failed\n\tproperty:',
      e,
  ...
  addColor(t, i, e = 1) {
    return new ColorController(this, t, i, e);
  }
  addFolder(t) {
    return new GUI({ parent: this, title: t });
  }
  load(t, i = !0) {
    return (
      t.controllers &&
        this.controllers.forEach((i) => {
          i instanceof FunctionController ||
  ...
  save(t = !0) {
    ...
    return (
      this.controllers.forEach((t) => {
        if (!(t instanceof FunctionController)) {
